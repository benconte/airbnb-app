        ...
        <div className="flex-none w-[260px] h-full flex items-center justify-center cursor-pointer border border-gray-200 rounded-2xl hover:shadow-lg transition-shadow bg-white relative">
          <div className="flex flex-col items-center">
            <div className="flex -space-x-4 mb-4">
              <img src="https://images.unsplash.com/photo-1502005229762-cf1b2da7c5d6?auto=format&fit=crop&w=400&q=80" alt="img1" className="w-16 h-16 rounded-lg border-2 border-white object-cover transform -rotate-12 translate-y-2 z-10 shadow-sm" />
              <img src="https://images.unsplash.com/photo-1568605114967-8130f3a36994?auto=format&fit=crop&w=400&q=80" alt="img2" className="w-20 h-20 rounded-lg border-2 border-white object-cover z-20 shadow-md" />
              <img src="https://images.unsplash.com/photo-1493809842364-78817add7ffb?auto=format&fit=crop&w=400&q=80" alt="img3" className="w-16 h-16 rounded-lg border-2 border-white object-cover transform rotate-12 translate-y-2 z-10 shadow-sm" />
            </div>
    ...
    <Link to={`/listing/${listing.id}`}>
      <div className="flex-none w-[260px] cursor-pointer group flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-0.5 px-0.5">
          ...
          <p className="text-[15px] text-gray-500">{listing.priceText}</p>
        </div>
      </div>
    </Link>
